...
-- Question 5: Lấy ra thông tin account, fullname dài nhất và department_id = 3;
SELECT *
FROM account
...
-- Question 6: Lấy ra group_name được tạo trước ngày 2019-12-20
SELECT group_name
FROM `group`
...
-- Question 8: Lấy ra code của table exam có duration >= 60 và created_date trước 2019-12-20
SELECT code
FROM exam
...
-- Question 11: Lấy ra account có full_name bắt đầu bằng chữ "D" kết thúc chữ "o"
SELECT *
FROM account
